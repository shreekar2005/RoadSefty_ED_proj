...
area1_pointA = (500,0)
area1_pointB = (500,1800)
area1_pointC = (1400,0)
area1_pointD = (1400,1800)
#time.sleep(2)
...
def draw_boxes(img, bbox, identities=None, categories=None, names=None, offset=(0, 0)):
    ...
    for i, box in enumerate(bbox):
        ...
        if (midpoint_x > area1_pointA[0] and midpoint_x < area1_pointD[0]) and (midpoint_y > area1_pointA[1] and midpoint_y < area1_pointD[1]):
            if(names[cat]=="truck" or names[cat]=="car" or names[cat]=="motorcycle"):
                midpoint_color = (0,0,255)
                if(midpoint_x<(area1_pointA[0]+area1_pointD[0])/2):
                    leftcount+=1
                else:
                    rightcount+=1
        ...
        cv2.circle(img,center_point,radius=1,color=midpoint_color,thickness=8)
    ...
    if(timediff>5000):
        if(rightcount>0) : 
            ...
            pyaut.typewrite("1")
            pyaut.press("enter")
            #speak.Speak("vehical comming from left")  
                
        elif(leftcount>0) :
            start_time = datetime.now()
            pyaut.typewrite("2")
            pyaut.press("enter")
            #speak.Speak("vehical comming from right")  
    end_time=datetime.now()     
